...
public class TestShipTemplate implements ShipTemplate {
    ...
    public TestShipTemplate(double movement, int totalProductionNeeded, String name){
        ...
        actions = action;
        this.name = name;
        purpose = "overallCombat";
        ifOnlyChassis = false;

        weapons = new Weapon[3];
        defenses = new Defense[3];

    }

    public TestShipTemplate(double movement, int totalProductionNeeded){
        ifOnlyChassis = true;
        shipClass = "testShip";
        this.movement = movement;
        this.totalProductionNeeded = totalProductionNeeded;
    ...
    public ShipTemplate getClone(){
        TestShipTemplate temp = new TestShipTemplate(movement, initialProductionNeeded, name);
        temp.setStats(weapons, defenses);
        return temp;
    }

    public ShipTemplate getNonTemplateVersion(String newName){
        return new TestShipTemplate(movement, initialProductionNeeded, newName);
    }
